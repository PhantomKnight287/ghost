...
export function RepositoryTabs({ code,defaultBranch,branches }: { code: ReactNode, branches?: string[], defaultBranch:string | null }) {
  ...
  return (<div className="flex flex-row items-center justify-between w-full" >
    ...
    <Select
      ...
      onValueChange={(branch) =>
        router.push(`/${username}/${repo}/tree/${encodeURIComponent(branch)}`)
      }
    >
