...
/** Object id and size of a file at a ref, or null when the path is missing or is not a file - one 404 for the caller either way. */
...
export function isTextBlob(content: Buffer | null): content is Buffer {
