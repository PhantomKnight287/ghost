...
/** A request body that can be read more than once and never has to exist in memory all at once. Push bodies routinely exceed the 2 GiB ceiling on a single Buffer operation, so nothing downstream may assume a Buffer. */
