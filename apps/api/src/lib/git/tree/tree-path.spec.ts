...
describe('normalizeTreePath', () => {
  ...
  /** Express percent-decodes a query value exactly once, so these are the strings that actually arrive. Decoding again in the app would turn the doubly-encoded forms back into traversal. */
